    ...
    while l_frame is not None:
        ...
        if not silent:
            print("Frame Number=", frame_number,
                  "Itens=", num_rects,
                  "Alertas EPI=", (obj_counter[PGIE_CLASS_ID_SCAPCOL] + obj_counter[PGIE_CLASS_ID_SCAP] + obj_counter[PGIE_CLASS_ID_SCOL]),
                  "OK=", obj_counter[PGIE_CLASS_ID_OK],
                  "Caminh.=", obj_counter[PGIE_CLASS_ID_CMN],
                  "Empil.=", obj_counter[PGIE_CLASS_ID_EMP],
                  "Carros=", obj_counter[PGIE_CLASS_ID_CAR]
                  )
