...
def main(args):
    ...
    pgie.set_property('config-file-path', "/opt/nvidia/deepstream/deepstream/sources/deepstream_python_apps/apps/deepstream-imagedata-multistream-test/config_infer_primary_yoloV8.txt")
